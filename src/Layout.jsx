    ...
    return (
        <>
            <div className="grid grid-cols-12 sm:grid-rows-12 gap-0 h-screen border-collapse overflow-hidden text-gray-600 dark:text-white ">
                <div className=" hidden sm:block sm:col-span-2 sm:row-span-12 px-3 h-screen bg-neutral-200 dark:bg-gray-950 overflow-auto"><Header /></div>
                ...
                <div className=' bg-gray-100 dark:bg-gray-800 col-span-12 sm:col-span-10 sm:row-span-1 content-center'><Footer /></div>
            </div> 
        </>
    )
}
